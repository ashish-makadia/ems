...
var Grid = fc.Grid = RowRenderer.extend({
	...
	bgCellHtml: function(cell) {
		...
		var tomorrow =  new Date(date.format('YYYY-MM-DD'));
		tomorrow.setDate(date.date()+1);
		var ddate= tomorrow.getDate();
		if(ddate < 10){
			ddate = "0" + ddate;
		}
		...
		var Ndate = year+"-"+mm+"-"+ddate;

		classes.unshift('fc-day', view.widgetContentClass);

		return '<td class="' + classes.join(' ') + '"' +
			' data-date="' + Ndate + '"' + // if date has a time, won't format it
			'></td>';
	},
...
*/
	...
	numberCellHtml: function(cell) {
		...
		var date = cell.start;
		var tomorrow =  new Date(date.format());
		tomorrow.setDate(date.date()+1);
		var ddate= tomorrow.getDate();
		var ddate1= tomorrow.getDate();
		if(ddate < 10){
			ddate = "0" + ddate;
		}
		var mm = tomorrow.getMonth() + 1;
		...
		return '' +
			'<td class="' + classes.join(' ') + '" data-date="' + Ndate + '">' +
				ddate1 +
			'</td>';
	},
