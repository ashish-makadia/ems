                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (!this.options.cycleSteps)
                                switch ((this.main.find(".sw-btn-prev").removeClass("disabled"), this.main.find(".sw-btn-next").removeClass("disabled"), this.main.find(".submit-btn").attr("style","display:none"), this._getStepPosition(t))) {
                                    case "first":
                                        this.main.find(".sw-btn-prev").addClass("disabled");
                                        break;
                                    case "last":
                                        this.main.find(".sw-btn-next").addClass("disabled");
                                        this.main.find(".submit-btn").removeAttr("style");
                                        break;
                                    default:
