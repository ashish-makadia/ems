@extends('layouts.app')
@section('subheader','Department Listing')
@section('content')
		...
		<div class="m-portlet__head-tools">
			<ul class="m-portlet__nav">
				...
				<li class="m-portlet__nav-item">
					<a  data-toggle="modal" onclick="openNewModal('Add Department','{{route('department.create')}}')" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
						<span>
