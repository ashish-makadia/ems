                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            {{-- <a href="#" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Support</a> --}}
                            <a href="{{route('frontend.customer')}}" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Customer Register</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            {{-- <a href="{{route('customer.support')}}" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Support</a> --}}
                            <a href="{{route('frontend.customer')}}" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Customer Register</a>
                        </div>
                    </div>
                </div>
