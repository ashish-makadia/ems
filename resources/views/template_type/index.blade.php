@extends('layouts.app')
@section('subheader','Tamplate Type Listing')
@section('content')
	...
	<div class="m-portlet__head">
		...
		<div class="m-portlet__head-tools">
			<ul class="m-portlet__nav">
				@can('add template type')
				<li class="m-portlet__nav-item">
					<a  data-toggle="modal" onclick="openNewModal('Add Template Type','{{route('templatetype.create')}}')" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
						<span>
