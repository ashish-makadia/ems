@extends('layouts.app')
@section('subheader',__('messages.project'))
@section('content')
		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">
					{{__('messages.add')}} {{ __('messages.project')}}
				</h3>
			</div>
		</div>
	</div>
	<div class="m-portlet__body">
        <form id="projectForm" action="{{ route('project.store')}}" method="POST" class="userForm" enctype="multipart/form-data">
